...
def populate_stage(stage: Path, source_root: Path, wheelhouse: Path, version: str) -> None:
    ...
    shutil.copy2(offline / "generate_windows_config.py", tools / "generate_windows_config.py")
    shutil.copy2(offline / "sync-now.bat.template", tools / "sync-now.bat.template")
